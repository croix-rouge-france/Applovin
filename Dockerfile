...
# Étape 1 : Préparer les dépendances système de base
...
# Étape 3 : Installer NGINX, PHP 8.2 et ses extensions nécessaires
RUN apt-get update && apt-get install -y \
    nginx \
    php8.2-fpm \
    php8.2-gd \
...
# Étape 8 : Copier la configuration NGINX
COPY nginx.conf /etc/nginx/nginx.conf

# Étape 9 : Permissions correctes
RUN chown -R www-data:www-data /var/www/html && chmod -R 755 /var/www/html

# Étape 10 : Exposer le port HTTP
EXPOSE 80

# Étape 11 : Lancer PHP-FPM et NGINX
